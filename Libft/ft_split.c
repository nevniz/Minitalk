...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/19 20:33:58 by llawrenc          #+#    #+#             */
/*   Updated: 2021/10/21 21:25:07 by llawrenc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_split(char const *s, char c)
{
	...
	tmp = (char **)(malloc(sizeof(char *) * (count_strings + 1)));
	if (tmp == NULL)
		return (NULL);
	tmp = fill_td_array(tmp, (char *)s, c, count_strings);
	if (tmp == NULL)
		return (NULL);
	return (tmp);
}
